...
void Notice::noticeOn(Client* client)
{
...
void Notice::executeNotice(Client* client)
{
    ...
    {
        Client* pClient = isExistNickname(targetName);
...
Channel* Notice::isExistChannelName(std::string name)
{
...
Client* Notice::isExistNickname(std::string name)
{
...
int Notice::isKicked(Client* client, Channel* channel)
{
...
int Notice::checkClientLevel(Client* client)
{
