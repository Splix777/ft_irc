...
# define _CHANOPRIVSNEEDED(nick, channel) (":IRC 482 " + nick + " " + channel + " :You're not channel operator")
...
// KICK
# define _CHCHANNELNOTEXIST(nick, channel) (":IRC 403 " + nick + " " + channel + " :No such channel.")
# define _USERNOTINCHANNEL(nick, target, channel) ("441 " + nick + " " + target + " " + channel + " :The user is not on this channel.")
# define _KICK(user_id, channel, kicked, reason) (user_id + " KICK " + channel + " " + kicked + " " + reason)
